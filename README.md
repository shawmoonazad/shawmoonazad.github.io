...
## About me 
I graduated with *manga cum laude* honors from North South University with a Bachelor of Science in Computer Science and Engineering. I've worked as a teaching assistant for two years and now working as a [research assistant](https://sites.google.com/view/nsuopticslab/members?authuser=0) at NSU under the supervision of [DR. MAHDY RAHMAN CHOWDHURY](http://ece.northsouth.edu/people/mahdy-rahman-chowdhury/) and [DR. SIFAT MOMEN](http://ece.northsouth.edu/people/dr-sifat-momen/). Here, I actively pursue research related to applied machine learning in analyzing and modeling health and economics area. In quantum computing, I've been working in the areas of quantum key distribution and quantum machine learning. Apart from this, I'm also contributing to progressing research facilities in Bangladesh through Mahdy Research Academy as a Research Assistant and Coordinator. Here, I've actively taught research methodologies and domain-specific topics to 800+ students. 

## Research Interest 
#### Applied Machine Learning, Natural Language Processing, Quantum Key Distribution, Quantum Machine Learning
...
[**IET Qunatum Communication**] [**Q1**] [**Under Review**] Submitted: 2024, March 10. [arXiv preprint](arXiv:2311.18471.)

## Work Experience
**Research Assistant @ North South University (_October 2023 - Present_)**
- I applied quantum computing to build a secure image transmission protocol scheme using quantum key distribution and a chaotic system.
...
**Abstract**  
In recent years, significant progress has been made in large language models (LLMs) in terms of question-answer tasks. However, these LLMs have been facing significant challenges regarding hallucination, misinformation, and changes in existing information. Challenges like these are prevalent when it comes to training in low-resource subjects. Critical domains such as the Liberation War of 1971 require accurate information in order to make a reliable LLM system. Fine-tuning LLMs on diverse datasets is a potential solution for improving LLM performance in specific domain question-answering tasks. However, it is worth noting that this approach can be resource-intensive and costly. Another solution to this issue can be solved by combining LLMs with a large corpus of external data, and we have done precisely that. Combining LLM, such as Stable Vicuna, with human-verified data sources, we present EkattorQA: an open-source conversational AI-based retrieval question-answering system for Bangladesh history. Throughout our work, we have used different open-source projects. Answers generated from our chat model have been verified and evaluated against different LLMs. Our evaluation metric was based on answers to the same question by ChatGPT, GPT-3.5, Vicuna(13B), and Koala(13B). We have taken human evaluation of these answers by assigning a score to all the answers from 1-10. We have also evaluated the chat model with different levels of difficulty-based questions. Our work shows a promising scalability future of such chat models in specific domains.  
